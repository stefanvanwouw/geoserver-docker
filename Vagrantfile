...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "docker" do |d|
      d.build_image "-t geoserver_tomcat /vagrant/tomcat"
  end
  ...
  custom_docker = "docker stop geoserver_tomcat; docker rm geoserver_tomcat; exit 0"
